...
circles[0].addEventListener("click", function(){
  ...
  setTimeout(function(){
    ...
    hint.innerHTML = `<div id="giff"><img src="${W?"/final/files/ghost.gif":"/final/files/paridhapangal.gif"}"></div><h1>${W?"Unlocked :D":"<span style=\"color:#800\">YOU DIED</span>"}</h1>`;
    if(W){
        window.location.assign('d41077ae7a1b67bf823793dcd32ef1143f020413.html');
    }
